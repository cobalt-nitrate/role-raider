...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from role_raider.discovery.jobspy import parse_proxy
...
def _load_base_urls() -> dict[str, str | None]:
    ...
    from role_raider.config import load_base_urls
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from role_raider.discovery.smartextract import extract_json
