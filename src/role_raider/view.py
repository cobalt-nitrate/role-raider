"""Role Raider HTML Dashboard Generator.
...
from role_raider.config import APP_DIR, DB_PATH
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.role_raider/dashboard.html.
...
<title>Role Raider Dashboard</title>
<style>
