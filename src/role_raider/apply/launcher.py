...
from role_raider.apply import chrome, dashboard, prompt as prompt_mod
from role_raider.apply.chrome import (
    launch_chrome, cleanup_worker, kill_all_chrome,
    reset_worker_dir, cleanup_on_exit, _kill_process_tree,
    BASE_CDP_PORT,
)
from role_raider.apply.dashboard import (
...
def _load_blocked():
    from role_raider.config import load_blocked_sites
...
def acquire_job(target_url: str | None = None, min_score: int = 7,
    ...
    try:
        ...
        from role_raider.config import is_manual_ats
